...
function getWifiConnectStatus()
{
    ...
    if (xhr.readyState == 4 && xhr.status == 200)
    {
        ...
        {
            document.getElementVyId("wifi_connect_status").innerHTML = "<h4 class='rd'>Failed to Connect. Please check you AP credentials and compatibility</h>";
            stopWifiConnectStatusInterval();
        }
        else if(response.wifi_connect_status == 3)
        {
            document.getElementVyId("wifi_connect_status").innerHTML = "<h4 class='gr' >Connection Success!</h>";
            stopWifiConnectStatusInterval();
            getConnectInfo();
        }
    }
...
/*
Connect Wifi function called using the SSID and password entered intot the text fiels.
*/
function connectWifi()
{
    ...
    $.ajax({
        ...
        method: 'POST',
        cache: false,
        headers: {'my-connectossid': selectSSID, 'my-connect-pwd': pwd},
...
/*
Checks credential on connect_wifi_button click
*/
...
/*
Gets the connection info for displaying on the webpage
*/
...
/*
Get the ESP32's AP SSID for displaying on the web page/
*/
function  getSSID()
{
