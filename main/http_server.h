...
typedef enum http_server_wifi_connect_status
{
    ...
    HTTP_WIFI_STATUS_CONNECT_SUCCES,
...
@param msgIDL message ID from the http_server_message_e enum
@return pdTrue if an item was successfully sent to the queu, otherewise pdFALSE
*/
