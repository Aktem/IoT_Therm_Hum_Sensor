...
/*
ISR handler fot eh wifi reset button
*/
...
to the Wifi application to disconnect from wifi and clear the saveds credentials.
@param pvParam param which can be passed to the task.
*/
